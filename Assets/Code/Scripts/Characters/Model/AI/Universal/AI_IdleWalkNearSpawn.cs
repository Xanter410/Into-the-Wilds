    ...
    public class AI_IdleWalkNearSpawn : Node
    {
        ...
        public override NodeState Evaluate()
        {
            ...
            else
            {
                ...
                // Если от текущего положения до цели меньше половины клетки.
                // Считаем что главная цель достигнута.
                ...
                else
                {
                    ...
                    if (distanceToSubTarget < 0.15f)
                    {
                        ...
                        {
                            // Цель маршрута _pathToTarget достигнута.
                            // Считаем что общая цель тоже достигнута.
